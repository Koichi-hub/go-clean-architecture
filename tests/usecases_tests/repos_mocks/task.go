...
func (taskRepoMock *TaskRepoMock) Create(task entities.Task) (entities.Task, error) {
...
func (taskRepoMock *TaskRepoMock) Update(task entities.Task) (entities.Task, error) {
	args := taskRepoMock.Called(task)

	return task, args.Error(0)
}
